...
const ProgramCard = ({ program }) => {
    ...
    return (
        <article className='bg-white rounded-xl border border-gray-100 overflow-hidden flex flex-col hover:border-[#0A6FA7]/30 hover:shadow-xl hover:shadow-[#0A6FA7]/5 transition-all duration-300 h-full group'>
            ...
            <div className='p-5 flex flex-col flex-1'>
                ...
                <div className='pt-4 border-t border-gray-50 mt-auto'>
                    <Link
                        href={`/programs/${slug}`}
                        className='flex items-center justify-center w-full py-2.5 rounded-lg text-sm font-bold text-[#0A6FA7] bg-[#0A6FA7]/5 hover:bg-[#0A6FA7] hover:text-white transition-all duration-300'
                    >
                        View Details
                    </Link>
                </div>
