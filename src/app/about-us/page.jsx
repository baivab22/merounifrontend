...
const AboutUs = () => {
    ...
    React.useEffect(() => {
        const fetchContent = async () => {
            try {
                const configRes = await getConfigByType('legal_about_us')
        ...
        <>
            ...
            <div className='min-h-screen bg-white'>
                <div className='max-w-[800px] mx-auto px-6 py-16 lg:py-24'>
                    <h1 className='text-3xl lg:text-4xl font-black text-gray-900 mb-8'>About Us</h1>
                    ...
                    {loading ? (
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: content || '<p>No About Us content available.</p>' }}
                        />
                    )}
                </div>
            </div>
