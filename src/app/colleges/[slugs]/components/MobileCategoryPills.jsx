...
const MobileCategoryPills = ({ college }) => {
  ...
  const handleScrollTo = (name) => {
    ...
    if (element) {
      const headerOffset = 180 // Adjusted for sticky header + navbar + search
  ...
  return (
    <div className={`md:hidden w-full bg-white z-[50] border-b border-gray-100 ${
      isScrolled ? 'fixed top-[120px] left-0 right-0 shadow-sm' : 'sticky top-[120px]'
    }`}>
