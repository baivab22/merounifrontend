...
export async function generateMetadata({ params }) {
    ...
    try {
        const data = await services.news.getBySlug(slugs)
        ...
        return {
            ...
            openGraph: {
                title: title,
                description: description,
                url: `https://merouni.com/news/${slugs}`,
...
export default async function NewsPage({ params }) {
    ...
    return <NewsContent initialNews={news} initialSimilarNews={similarNews} slugs={slugs} />
}
