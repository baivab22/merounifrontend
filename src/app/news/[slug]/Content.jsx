...
const NewsContent = ({ initialNews, initialSimilarNews, slug }) => {
  ...
  useEffect(() => {
    const fetchAdditionalData = async () => {
      try {
        const [newsData] = await Promise.all([
          !initialNews ? services.news.getBySlug(slug) : Promise.resolve(null)
        ])
        ...
        if (newsData) {
          ...
          const fullData = await services.news.getBySlug(slug)
    ...
    fetchAdditionalData()
  }, [slug, initialNews, initialSimilarNews])
