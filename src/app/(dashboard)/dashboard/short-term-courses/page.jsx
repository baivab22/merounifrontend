...
export default function SkillsCoursesManager() {
  ...
  const loadCourses = async (page = 1, explicitSearch, explicitStatus) => {
    const search = explicitSearch !== undefined ? explicitSearch : searchQuery
    const status = explicitStatus !== undefined ? explicitStatus : statusFilter
  ...
  const onSubmit = async (data) => {
    const formattedData = {
      ...
      seats_available:
        data.seats_available !== '' ? parseInt(data.seats_available) : undefined
    }
  ...
  const handleEdit = (course) => {
    ...
    setValue('meta_description', course.meta_description || '')
  ...
  const columns = useMemo(
    () => [
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-3'>
            ...
            <div className='flex flex-col'>
              ...
              <span className='text-[10px] text-gray-400 uppercase font-bold tracking-wider line-clamp-1'>
                {row.original.institution_name || 'Individual'}
              </span>
            </div>
          </div>
        )
        ...
        cell: ({ getValue }) =>
          getValue() > 0 ? (
            <span className='font-bold text-gray-700'>
              Rs. {parseFloat(getValue()).toLocaleString()}
            </span>
          ) : (
      ...
      },
      {
        ...
        cell: ({ getValue }) => (
          <span className='capitalize text-xs font-medium text-gray-600 px-2 py-0.5 bg-gray-50 rounded border border-gray-100'>
            {getValue() || 'online'}
          </span>
        )
      },
    ...
    <div className='w-full'>
      ...
      <div className='bg-white rounded-md shadow-sm border overflow-hidden'>
        <Table
          ...
          onPageChange={(newPage) => loadCourses(newPage, undefined, undefined)}
          showSearch={false}
        />
      </div>
                ...
                <div className='lg:col-span-8 space-y-8'>
                  ...
                  <div className='bg-white p-8 rounded-2xl shadow-sm border border-gray-100'>
                    <SectionHeader
                      ...
                      subtitle='Primary details of the short term course'
                    />
                  ...
                  <div className='bg-white p-8 rounded-2xl shadow-sm border border-gray-100'>
                    <SectionHeader
                      ...
                      subtitle='In-depth information about the course curriculum'
                    />
                    <div className='pt-2'>
                      <Label className='text-gray-700 font-semibold mb-2.5 block text-sm'>
                        Course Body Content
                      </Label>
                      <Controller
                        name='content'
                ...
                <div className='lg:col-span-4 space-y-8'>
                  ...
                  <div className='bg-white p-6 rounded-2xl shadow-sm border border-gray-100'>
                    <SectionHeader
                      ...
                      subtitle='Timing and availability'
                    />
                  ...
                  <div className='bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4'>
                    ...
                    <div className='space-y-4'>
                      <div className='flex items-center gap-3 p-3 bg-amber-50 rounded-lg border border-amber-100'>
                        ...
                        <Label
                          htmlFor='is_featured'
                          className='cursor-pointer text-amber-900 font-medium text-sm'
                        >
                          Feature this course
                        </Label>
                      </div>
                  ...
                  {/* SEO Settings */}
                  <div className='bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4'>
                    <SectionHeader icon={FileText} title='SEO Settings' />
                    <div className='space-y-4'>
          ...
          {viewingCourse && (
            <div className='space-y-4 text-sm'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <p className='font-bold text-gray-400 uppercase text-[10px]'>
                    Title
                  </p>
                  <p className='font-bold'>{viewingCourse.title}</p>
                </div>
                <div>
                  <p className='font-bold text-gray-400 uppercase text-[10px]'>
                    Price
                ...
                <div>
                  ...
                  <p>{viewingCourse.duration}</p>
                </div>
                <div>
                  <p className='font-bold text-gray-400 uppercase text-[10px]'>
                    Mode
                  </p>
                  <p className='capitalize'>{viewingCourse.course_type}</p>
                </div>
                <div>
                  <p className='font-bold text-gray-400 uppercase text-[10px]'>
                    Status
                ...
                <div>
                  ...
                  <p>{viewingCourse.is_featured ? 'Yes' : 'No'}</p>
                </div>
              </div>
              <div>
                <p className='font-bold text-gray-400 uppercase text-[10px]'>
