...
import { Globe, MapPin, Edit2, Trash2, Key, Eye } from 'lucide-react'
      ...
      return (
        <div className='flex flex-col'>
            ...
            <div className='flex items-center gap-1.5 text-xs text-slate-500 mt-1'>
              ...
              {mapUrl && isGoogleMap && (
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className='text-[#387cae] hover:underline'
                >
                  (Map)
                </a>
              )}
          ...
          {websiteUrl && (
            ...
            >
              <Globe className='inline w-3.5 h-3.5' /> {websiteUrl}
            </a>
          )}
        </div>
      )
      ...
      return (
        <div className='flex gap-2'>
          ...
          <button
            ...
            title={hasAccount ? 'Update Credentials' : 'Create Credentials'}
          >
