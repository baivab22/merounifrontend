                    ...
                    <div className='space-y-3'>
                      {program.colleges.map((college) => (
                        <div key={college.id} className='group'>
                          {college.slug ? (
                            <Link href={`/colleges/${encodeURIComponent(college.slug)}`} className='flex items-center justify-between py-3 px-4 rounded-xl border border-gray-50 bg-gray-50/50 hover:bg-white hover:border-[#0A6FA7] hover:shadow-xl hover:shadow-[#0A6FA7]/5 transition-all text-gray-800' >
